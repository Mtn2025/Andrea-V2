...
export const SimulatorMixin = {
    ...
    async startTest() {
        ...
        const wsUrl = window.USE_V2_SIMULATOR
            ? `${protocol}//${window.location.host}/ws/simulator/v2/stream`
            : `${protocol}//${window.location.host}/api/v1/ws/media-stream?client=browser`;
